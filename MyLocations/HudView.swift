...
//        hudView.backgroundColor = UIColor(red: 1, green: 0, blue: 0, alpha: 0.5)
    ...
    override func draw(_ rect: CGRect) {
        ...
        //add text
        let attribs = [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16.0),
...
//            })
            ...
            UIView.animate(withDuration: 1, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.5, options: UIView.AnimationOptions.layoutSubviews, animations: {
                self.alpha = 1
                self.transform = CGAffineTransform.identity
            }, completion: nil)
        }
